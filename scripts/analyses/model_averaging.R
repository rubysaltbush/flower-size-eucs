...
pgls_data <- eucvarscaled %>%
  dplyr::select(tree_names, logbudsize_mm2, meanAVP, meanMAT, 
...
for(i in 1:length(formulas)){
  cand_mod[[i]] <- nlme::gls(as.formula(formulas[[i]]),
                             data = pgls_data,
...
# Mod1  7 2162.23      1.70  0.29    -0.09 0.06
# Mod3  6 2170.49      9.97  0.00    -0.08 0.06
# Mod5  6 2160.53      0.00  0.69    -0.10 0.05
# Mod7  5 2168.51      7.99  0.01    -0.07 0.05
# Mod9  6 2177.47     16.94  0.00    -0.03 0.05
# Mod11 5 2185.64     25.12  0.00    -0.02 0.05
# Mod13 5 2175.55     15.02  0.00    -0.03 0.05
# Mod15 4 2183.81     23.29  0.00    -0.01 0.05
# Mod17 6 2177.58     17.05  0.00     0.01 0.05
# Mod19 5 2187.03     26.51  0.00     0.03 0.05
# Mod21 5 2176.70     16.17  0.00     0.00 0.05
# Mod23 4 2185.16     24.63  0.00     0.02 0.05
# Mod25 5 2180.94     20.41  0.00     0.02 0.05
# Mod27 4 2189.94     29.41  0.00     0.03 0.05
# Mod29 4 2179.46     18.93  0.00     0.01 0.05
# Mod31 3 2187.94     27.42  0.00     0.03 0.05
# 
# Model-averaged estimate: -0.09 
# Unconditional SE: 0.05 
# 95% Unconditional confidence interval: -0.2, 0.01
...
#   
#       K     AIC Delta_AIC AICWt Estimate   SE
# Mod1  7 2162.23      1.70  0.19    -0.14 0.04
# Mod2  6 2162.76      2.23  0.14    -0.13 0.04
# Mod5  6 2160.53      0.00  0.44    -0.13 0.04
# Mod6  5 2161.89      1.36  0.22    -0.12 0.04
# Mod9  6 2177.47     16.94  0.00    -0.14 0.04
# Mod10 5 2175.76     15.23  0.00    -0.14 0.04
# Mod13 5 2175.55     15.02  0.00    -0.13 0.04
# Mod14 4 2173.99     13.46  0.00    -0.13 0.04
# Mod17 6 2177.58     17.05  0.00    -0.14 0.04
# Mod18 5 2175.62     15.09  0.00    -0.15 0.04
# Mod21 5 2176.70     16.17  0.00    -0.14 0.04
# Mod22 4 2174.71     14.18  0.00    -0.13 0.04
# Mod25 5 2180.94     20.41  0.00    -0.14 0.04
# Mod26 4 2179.04     18.51  0.00    -0.14 0.04
# Mod29 4 2179.46     18.93  0.00    -0.14 0.04
# Mod30 3 2177.47     16.95  0.00    -0.14 0.04
# 
# Model-averaged estimate: -0.13 
# Unconditional SE: 0.04 
# 95% Unconditional confidence interval: -0.21, -0.05
...
#   
#       K     AIC Delta_AIC AICWt Estimate   SE
# Mod1  7 2162.23      0.00  0.55     0.03 0.05
# Mod2  6 2162.76      0.53  0.43     0.05 0.05
# Mod3  6 2170.49      8.26  0.01    -0.01 0.05
# Mod4  5 2170.40      8.17  0.01     0.01 0.04
# Mod9  6 2177.47     15.24  0.00     0.01 0.05
# Mod10 5 2175.76     13.53  0.00     0.02 0.05
# Mod11 5 2185.64     23.41  0.00    -0.02 0.05
# Mod12 4 2183.75     21.52  0.00    -0.01 0.04
# Mod17 6 2177.58     15.35  0.00     0.05 0.05
# Mod18 5 2175.62     13.39  0.00     0.05 0.05
# Mod19 5 2187.03     24.80  0.00     0.02 0.05
# Mod20 4 2185.31     23.08  0.00     0.01 0.04
# Mod25 5 2180.94     18.71  0.00     0.03 0.05
# Mod26 4 2179.04     16.81  0.00     0.03 0.05
# Mod27 4 2189.94     27.71  0.00     0.00 0.05
# Mod28 3 2188.32     26.09  0.00    -0.01 0.04
# 
# Model-averaged estimate: 0.03 
# Unconditional SE: 0.05 
# 95% Unconditional confidence interval: -0.06, 0.13
...
#   
#       K     AIC Delta_AIC AICWt Estimate   SE
# Mod1  7 2162.23      1.70  0.18    -0.18 0.04
# Mod2  6 2162.76      2.23  0.14    -0.16 0.04
# Mod3  6 2170.49      9.97  0.00    -0.18 0.04
# Mod4  5 2170.40      9.88  0.00    -0.16 0.04
# Mod5  6 2160.53      0.00  0.43    -0.18 0.04
# Mod6  5 2161.89      1.36  0.22    -0.15 0.04
# Mod7  5 2168.51      7.99  0.01    -0.18 0.04
# Mod8  4 2168.50      7.97  0.01    -0.16 0.04
# Mod17 6 2177.58     17.05  0.00    -0.09 0.04
# Mod18 5 2175.62     15.09  0.00    -0.09 0.04
# Mod19 5 2187.03     26.51  0.00    -0.08 0.04
# Mod20 4 2185.31     24.78  0.00    -0.08 0.04
# Mod21 5 2176.70     16.17  0.00    -0.08 0.04
# Mod22 4 2174.71     14.18  0.00    -0.08 0.04
# Mod23 4 2185.16     24.63  0.00    -0.08 0.04
# Mod24 3 2183.35     22.83  0.00    -0.08 0.04
# 
# Model-averaged estimate: -0.17 
# Unconditional SE: 0.04 
# 95% Unconditional confidence interval: -0.25, -0.08
...
#   
#       K     AIC Delta_AIC AICWt Estimate   SE
# Mod1  7 2162.23      1.70  0.18     0.17 0.04
# Mod2  6 2162.76      2.23  0.14     0.14 0.04
# Mod3  6 2170.49      9.97  0.00     0.18 0.04
# Mod4  5 2170.40      9.88  0.00     0.15 0.04
# Mod5  6 2160.53      0.00  0.43     0.18 0.04
# Mod6  5 2161.89      1.36  0.22     0.14 0.04
# Mod7  5 2168.51      7.99  0.01     0.18 0.04
# Mod8  4 2168.50      7.97  0.01     0.15 0.04
# Mod9  6 2177.47     16.94  0.00     0.08 0.04
# Mod10 5 2175.76     15.23  0.00     0.08 0.03
# Mod11 5 2185.64     25.12  0.00     0.09 0.04
# Mod12 4 2183.75     23.22  0.00     0.09 0.03
# Mod13 5 2175.55     15.02  0.00     0.09 0.04
# Mod14 4 2173.99     13.46  0.00     0.08 0.03
# Mod15 4 2183.81     23.29  0.00     0.09 0.04
# Mod16 3 2181.85     21.32  0.00     0.09 0.03
# 
# Model-averaged estimate: 0.16 
# Unconditional SE: 0.04 
# 95% Unconditional confidence interval: 0.08, 0.25

# model averaged estimate is strongest for bird richness (-0.17) and bat 
# presence/absence (0.16), then MAP (-0.13), then MAT (-0.09), AVP close to 0
