...
install.packages("terra") # does both raster and vector data, compatible with changes to R spatial data, v1.7-29
install.packages("ape") # basic package for phylogenetic trees and analysis, run version 5.7-1
